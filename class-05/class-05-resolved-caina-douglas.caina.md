...
```
	...
	2015-11-20T16:17:51.599-0200	connected to: localhost
	2015-11-20T16:17:51.600-0200	dropping: be-mean.pokemons
	2015-11-20T16:17:51.650-0200	imported 610 documents
...
```
var limit = 5;
db.pokemons.find().limit(limit).skip(limit*0)
...
db.pokemons.find().limit(limit).skip(limit*1)
...
db.pokemons.find().limit(limit).skip(limit*2)
...
```
db.pokemons.count({speed:{$gt:60}})
316

db.pokemons.count({name: /mon/i})
3
