...
``` JavaScript
adejair@junior ~/GitHub/be-mean-instagram/apostila/module-mongodb/data $ mongoimport -d be-mean -c pokemons --drop --file pokemons.json
...
adejair@junior ~/GitHub/be-mean-instagram/apostila/module-mongodb/data $ mongoimport -d be-mean -c restaurantes --drop --file restaurantes.json
...
``` JavaScript
junior(mongod-3.0.7) be-mean> db.restaurantes.distinct('cuisine')
[
  "Hamburgers",
  "Bakery",
  "Irish",
...
``` JavaScript
junior(mongod-3.0.7) be-mean> db.pokemons.distinct('types')
[
  "normal",
  "fire",
  "water",
...
``` JavaScript
junior(mongod-3.0.7) be-mean> db.pokemons.count({})
610

junior(mongod-3.0.7) be-mean> db.pokemons.count({types: 'fire'})
47

junior(mongod-3.0.7) be-mean> db.pokemons.count({defense: {$gt: 70}})
250
