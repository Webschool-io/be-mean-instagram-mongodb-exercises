...
```
	mongoimport --db be-mean-pokemons --collection pokemons --drop pokemons.json 
	2016-11-02T00:47:10.653-0200	connected to: localhost
	2016-11-02T00:47:10.653-0200	dropping: be-mean-pokemons.pokemons
	2016-11-02T00:47:10.673-0200	imported 610 documents
```
