...
## Liste Pokemons com a altura menor que 0.5
...
## Liste Pokemons com a altura maior ou igual que 0.5
...
## Liste Pokemons com a altura menor ou igual que 0.5 E do tipo grama
...
## Liste Pokemons com o name Pikachu ou com attack menor ou igual que 30

```
miller-nt(mongod-3.0.7) be-mean-pokemons> var query = {$or: [{name: /pikachu/i}, {attack: {$lte: 30}}]}
miller-nt(mongod-3.0.7) be-mean-pokemons> db.pokemons.find(query)
{
  "_id": ObjectId("5643fcd754d8612c0d6f4c28"),
  "name": "Bulbasaur",
...
## Liste Pokemons com o attack maior ou igual que 48 e com height menor ou igual que 1.2

```
miller-nt(mongod-3.0.7) be-mean-pokemons> var query = {$and: [{attack: {$gte: 48}},{height: {$lte: 1.2}}]}
miller-nt(mongod-3.0.7) be-mean-pokemons> db.pokemons.find(query)
{
  "_id": ObjectId("5643fcd754d8612c0d6f4c2a"),
  "name": "Raichu",
