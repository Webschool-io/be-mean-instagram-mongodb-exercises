...
```
HP(mongod-3.0.7) be-mean-pokemons> var query = { height: { $lt: 0.5 } };
HP(mongod-3.0.7) be-mean-pokemons> db.pokemons.find(query);
{
...
```
HP(mongod-3.0.7) be-mean-pokemons> var query = { height: { $gte: 0.5 } };
HP(mongod-3.0.7) be-mean-pokemons> db.pokemons.find(query);
{
...
```
HP(mongod-3.0.7) be-mean-pokemons> var query = { $and: [ { height: { $lte: 0.5 } }, { type: 'grama' } ] };
HP(mongod-3.0.7) be-mean-pokemons> db.pokemons.find(query);
{
	"_id": ObjectId("5643fae0adb6ef20dd5aaa43"),
	"name": "Bulbassauro",
...
```
HP(mongod-3.0.7) be-mean-pokemons> var query = { $or: [ { name: 'Pikachu' }, { attack: { $lte: 0.5 } } ] };
HP(mongod-3.0.7) be-mean-pokemons> db.pokemons.find(query);
{
	"_id": ObjectId("5643fad0adb6ef20dd5aaa42"),
	"name": "Pikachu",
...
```
HP(mongod-3.0.7) be-mean-pokemons> var query = { $and: [ { attack: { $gte: 48 } }, { height: { $lte: 0.5 } } ] };
HP(mongod-3.0.7) be-mean-pokemons> db.pokemons.find(query);
{
	"_id": ObjectId("5643fad0adb6ef20dd5aaa42"),
	"name": "Pikachu",
