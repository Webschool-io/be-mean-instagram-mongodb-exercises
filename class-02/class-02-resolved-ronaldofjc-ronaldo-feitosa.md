...
## Liste quais databases possui no servidor
...
## Liste quais coleções possui nesta database
...
## Busque os pokemons a sua escolha, pelo nome, e armazene-o em uma variável chamada poke
...
## Modifique a sua description e salve-o
