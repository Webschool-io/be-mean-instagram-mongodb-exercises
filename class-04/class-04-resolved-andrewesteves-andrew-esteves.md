...
var mod = {$pushAll: {moves: ['bomb','fire']}};
var options = {multi: true};
db.pokemons.update(query, mod, options);

Andrew(mongod-3.0.4) be-mean-pokemons> db.pokemons.update(query, mod, options);
...
```
var query = {moves: {$in: ['investida', 'bomb']}};
...
Andrew(mongod-3.0.4) be-mean-pokemons> db.pokemons.remove(query);
