...
var moves = ["Tackle", "Growl"]
moves
[
  "Tackle",
  "Growl"
]
var update = {$set: {moves: moves}}
update
{
  "$set": {
    "moves": [
...
db.pokemons.update(query, update, options)
...
var update = {$set: {description: "Sem maiores informações"}, $setOnInsert: {name: "AindaNaoExisteMon", type: null, attack: null, defense: null, height: null, moves: null}}
update
{
  "$set": {
...
```js
var query = {moves: {$in: ["Investida", "Bonemerang"]}}
query
{
  "moves": {
    "$in": [
...
```js
var query = {moves: {$all: ["Growl", "Tail Whip", "Bone Club", "Headbutt", "Leer", "Focus Energy", "Bonemerang", "Rage", "False Swipe", "Thrash", "Fling", "Bone Rush", "Endeavor", "Double-Edge", "Retaliate"]}}
query
{
  "moves": {
    "$all": [
...
```js
var query = {moves: {$in: ["Investida"]}, defense: {$not: {$lte: 49}}}
query
{
  "moves": {
    "$in": [
...
```js
var query = {type: "Water", attack: {$lt: 50}}
query
{
  "type": "Water",
  "attack": {
